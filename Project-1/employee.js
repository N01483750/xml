...
loadData(`http://127.0.0.1:5500/xml-and-js/Project-1/employee.xml`, renderTable);
...
const resetTable = () => {
    ...
    inputControl.value = "";
    window.location = 'http://127.0.0.1:5500/xml-and-js/Project-1/employee.html'
}
